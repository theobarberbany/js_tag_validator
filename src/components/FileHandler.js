...
const mapStateToProps = (state) => {
  return {cardTitle: state.fileHandler.displayProps.cardTitle, cardIcon: state.fileHandler.displayProps.cardIcon, cardInfo: state.fileHandler.displayProps.cardInfo, status: state.fileHandler.displayProps.status};
}
